...
patterns={'POLCIV':'(((D|d)elegado|DELEGADO) (de|DE) ((P|p)olícia|POLICIA)|POL(I|Í)CIA (|JUDICI(Á|A)RIA)|CIV(Í|I)L)|((P|p)olic(i|í)a (|(J|j)udici(a|á)ria)|(C|c)iv(i|í)l)',
          'POLDE':r'(POL(I|Í)CIA)(| CIV(Í|I)L)( DO ESTADO| D(E|O|OS|A)) .+?(\,|\.|\r|\;|\n)',
          'POLSUB':r'(.+|)(POL(I|Í)CIA)(( CIV(Í|I)L)|)( DO ESTADO (DE|DO)| D(E|A|O))',
          'COMMON':r'(\,|\r|\.|\;|\n)', 'NAME':'([A-Z])([A-Z]+|[a-z]+) ([A-Z])([A-Z]+|[a-z]+)( |)(([A-Z])([A-Z]+|[a-z]+)|)',
          'UFFULL':r'([A-Z])([A-Z]|[a-z])+?(/|-)([A-Z][A-Z])( |\.|\;|\r)','COMAUX':r'(\-| \-|\/| \/)( |)([A-Z][A-Z]|[a-z][a-z])( |\.|\n|\;)',
...
adress={'ALAMEDA':r'(ALAMEDA|(A|a)lameda|(A|a)(L|l)\.) ([A-Z]|[a-z]).+?(\/|\-)(| )([A-Z][A-Z])', 'AVENIDA':r'(AVENIDA|(A|a)venida|(A|a)(V|v)\.) ([A-Z]|[a-z]).+?(\/|\-)(| )([A-Z][A-Z])',
        'BECO':r'(BECO|(B|b)eco|(B|b)(E|e|)(|\.)) ([A-Z]|[a-z]).+?(\/|\-)(| )([A-Z][A-Z])', 'BOULEVARD':r'(BOULEVARD|(B|b)oulevard|(B|b)(O|o)(\.|L|l)(|\.)) ([A-Z]|[a-z]).+?(\/|\-)(| )([A-Z][A-Z])',
        'ESTRADA':r'(ESTRADA|(E|e)strada|(E|e)(STR|str)\.) ([A-Z]|[a-z]).+?(\/|\-)(| )([A-Z][A-Z])', 'FAZENDA':r'(FAZENDA|(F|f)azenda|(F|f)(AZ|az)\.) ([A-Z]|[a-z]).+?(\/|\-)(| )([A-Z][A-Z])',
        'LADEIRA':r'(LADEIRA|(L|l)adeira|(L|l)(AD|ad)\.) ([A-Z]|[a-z]).+?(\/|\-)(| )([A-Z][A-Z])', 'LARGO':r'(LARGO|(L|l)argo|(L|l)(\.|GO|go)\.) ([A-Z]|[a-z]).+?(\/|\-)(| )([A-Z][A-Z])',
        'LOTEAMENTO':r'(LOTEAMENTO|(L|l)oteamento|(L|l)(OTE|ote)|(L|l)(OT|ot)\.) ([A-Z]|[a-z]).+?(\/|\-)(| )([A-Z][A-Z])',
        'PRAIA':r'(PRAIA|(P|p)raia|(P|p)(R|r)(\.|a\.|A\.)) ([A-Z]|[a-z]).+?(\/|\-)(| )([A-Z][A-Z])', 'PRAÇA':r'(PRA(Ç|C)A|(P|p)ra(ç|c)a|((P|p)(RÇ|rç|RC|rc)(\.|))) .+?(\/|\-)(| )([A-Z][A-Z])',
        'RODOVIA':r'(RODOVIA|(R|r)odovia|(R|r)(OD|od)\.) ([A-Z]|[a-z]).+?(\/|\-)(| )([A-Z][A-Z])', 'RUA':r'(RUA|(R|r)ua|(R|r)\.) ([A-Z]|[a-z]).+?(\/|\-|\-|\/)(| )([A-Z][A-Z])',
        'TRAVESSA':r'(TRAVESSA|(T|t)ravessa|(T|t)(RA|ra)\.) ([A-Z]|[a-z]).+?(\/|\-)(| )([A-Z][A-Z])',
        'VIA':r'(VIA|(V|v)ia) ([A-Z]|[a-z]).+?(\/|\-)(| )([A-Z][A-Z])', 'VIELA':r'(VIELA|(V|v)iela|((V|v)LA|la)) ([A-Z]|[a-z]).+?(\/|\-)(| )([A-Z][A-Z])'}

fullSearAdress={'AVENIDA':r'(AVENIDA|(A|a)venida|(A|a)(V|v)\.).+', 'RUA':r'(RUA|(R|r)ua|(R|r)\.).+', 'ESTRADA':r'(ESTRADA|(E|e)strada|(E|e)(STR|str)\.).+', 'RODOVIA':r'(RODOVIA|(R|r)odovia|(R|r)(OD|od)\.).+'}

typesSear={'OFI':r'(((O|o)f(i|í)c(io|ie|e))|(OF(I|Í)C(IO|E))|(OF\.|Of\.|of\.)).+', 'PROC':r'(PROCESSO|PROCEDIMENT(O|OS)|(P|p)rocediment(o|os)|(p|P)rocesso|(P|p)roc\.|PROC\.).+',
           'INQ':r'(((I|i)nqu(é|e)rito)|INQU(É|E)RITO|(IP|(I|i)(nq|NQ))( |\.)).+',
           'BO':r'((B|b)(|\.)(O|o)( |\.|\:|\-)|REDS|(R|r)eds|(B|b)oletim de (O|o)corr(ê|e)ncia|noticia(s|) crim(inais|e)|NOTICI(A|AS) CRIM(INAIS|E)|BOLETIM DE OCORR(Ê|E)NCIA|RDO|(R|r)(DO|do)( |\.|\:|\-)|Procedimento( |\.|\:|\-)).+',
           'DEPTPOL':r'(([0-9][0-9][0-9]|[0-9][0-9]|[0-9]|)(.+|)( |)(((S|s)uper|)((G|g)er|intend)(ê|e)ncia|(D|d)iretoria|(D|d)ivis(ã|a)o|(S|s)ub(\-|)divis(ã|a)o|(D|d)epartamento|(D|d)pto\.)( |)((D|d)(E|e|O|o|A|a)|)( |)((I|i)ntelig(ê|e)ncia|)( |)((P|p)ol(í|i)ci(amento|al|a)|)(((D|d)(E|e|O|o|A|a)|)( |)((R|r)epress(ã|a)o|(P|p)rote(ç|c)(ã|a)o)|)( |)(ao|(D|d)(E|e|O|o|A|a)|)(.+))|(([0-9][0-9][0-9]|[0-9][0-9]|[0-9]|)(.+|)( |)(((S|S)UPER|)((G|G)ER|INTEND)(Ê|E)NCIA|(D|D)IRETORIA|(D|D)IVIS(Ã|A)O|(S|S)UB(\-|)DIVIS(Ã|A)O|(D|D)EPARTAMENTO|(D|D)PTO\.)( |)((D|D)(E|E|O|O|A|A)|)( |)((I|I)NTELIG(Ê|E)NCIA|)( |)((P|P)OL(Í|I)CI(AMENTO|AL|A)|)(((D|D)(E|E|O|O|A|A)|)( |)((R|R)EPRESS(Ã|A)O|(P|P)ROTE(Ç|C)(Ã|A)O)|)( |)(AO|(D|D)(E|E|O|O|A|A)|)(.+))',
           'DELTIP':r'([0-9][0-9]|[0-9]|[0-9](\ª|a|\º|o|)|[0-9][0-9](\ª|a|\º|o|)|([A-Z]+)|([a-z]+)|)(\.|)(| |)(DELEGACIA|(D|d)elegacia|DISTRITO|(D|d)iatrito|(D|d)(|\.)(P|p))(|\.).+',
           'PRAZO':r'(((P|p)razo)( |)(|.+)((\:|\-)|((D|d)e))( |)(\:|\-|)( |)(([0-9][0-9][0-9]|[0-9][0-9]|[0-9]|([a-z]+) e ([a-z]+) e ([a-z]+)|([a-z]+) e ([a-z]+)|([a-z]+))( |)(\(([A-Z]|[a-z]).+\)|)|([A-Z].+))( |)((D|d)ia(s|m|)|(H|h)oras|(M|m)es(es|)|(H|h)|(hrs|Hrs|HRS)|(A|a)no(s|))|(((P|P)RAZO)( |)(|.+)((\:|\-)|((D|D)E))( |)(\:|\-|)( |)(([0-9][0-9][0-9]|[0-9][0-9]|[0-9]|([A-Z]+) E ([A-Z]+) E ([A-Z]+)|([A-Z]+) E ([A-Z]+)|([A-Z]+))( |)(\(([A-Z]|[A-Z]).+\)|)|([A-Z].+))( |)((D|D)IA(S|M|)|(H|H)ORAS|(M|M)ES(ES)|(A|A)NO(S|))))',
           'DESCR':r'(((N|n)ão) ((A|a)tendimento|(C|c)umprimento|(F|f)ornecimento)|((D|d)escumprimento)|(R|r)ecusa|(O|o)miss(ã|a)o|(atendimento do que ora|(R|r)e(tin|nit)(ê|e)ncia|(M|m)orisidade|(D|d)e(mora|longa))).+|(((N|N)ÃO) ((A|A)TENDIMENTO|(C|C)UMPRIMENTO|(F|F)ORNECIMENTO)|(ATENDIMENTO DO QUE ORA REQUISITA|(D|D)ESCUMPRIMENTO)|(R|R)ECUSA|(O|O)MISS(Ã|A)O|((R|R)E(TIN|NIT)(Ê|E)NCIA|(M|M)ORISIDADE|(D|D)E(MORA|LONGA))).+'}

typesSub={'OFI':r'(((O|o)f(i|í)c(io|ie|e))|(OF(I|Í)C(IO|E))|(OF\.|Of\.|of\.)).+?([0-9]).+', 'PROC':r'(PROCESS(O|OS)|PROCEDIMENT(O|OS)|(P|p)rocediment(o|os)|(P|p)rocess(o|os)|(P|p)roc\.|PROC\.).+?([0-9]).+',
           'INQ':r'(((I|i)nqu(é|e)rito)|INQU(É|E)RITO|(IP|(I|i)(nq|NQ))( |\.)).+?([0-9]).+',
           'BO':r'((B|b)(|\.)(O|o)( |\.|\:|\-)|REDS|(R|r)eds|(B|b)oletim de (O|o)corr(ê|e)ncia|noticia(s|) crim(inais|e)|NOTICI(A|AS) CRIM(INAIS|E)|BOLETIM DE OCORR(Ê|E)NCIA|RDO|(R|r)(DO|do)( |\.|\:|\-)|Procedimento( |\.|\:|\-)).+?([0-9]).+',
           'PRAZO':r'((([0-9][0-9][0-9]|[0-9][0-9]|[0-9]|([a-z]+) e ([a-z]+) e ([a-z]+)|([a-z]+) e ([a-z]+)|([a-z]+))( |)(\(([A-Z]|[a-z]).+\)|)|([A-Z]+))( |)((D|d)ia(s|m)|(H|h)oras|(H|h)|(hrs|Hrs|HRS)|(M|m)ese(s|)|(A|a)no(s|)))|((([0-9][0-9][0-9]|[0-9][0-9]|[0-9]|([A-Z]+) E ([A-Z]+) E ([A-Z]+)|([A-Z]+) E ([A-Z]+)|([A-Z]+))( |)(\(([A-Z]|[A-Z]).+\)|)|([A-Z]+))( |)((D|D)IA(S|)|(H|H)ORAS|(M|M)ES(ES|)|(A|A)NO(S|)))'}
...
pattSubs={'DELEGADO':r'((D|d)(e|o)l(e|o)(g|c)a(d(o|a))(\(a\)|)( |)((d|D)e|)( |)(Pokcia|Pajčia|(P|p)ol(i|í)ci(al|a)|)((T|t)itular|\n|)( |)(.+|))|((D|D)(E|O)L(O|E)(G|C)A(D(O|A))(\(A\)|)( |)((D|D)E|)( |)((P|P)OL(I|Í)CI(AL|A)|)((T|T)ITULAR|)( |)(.|..|...|))'}

pattLaw={r'(A|a)rt(\.|igo|)|(A|A)RT(\.|IGO|)##(21)(.+)((L|l)ei|)( |)(12(\.|)850)(\/|\-|\.|)(13)':'Art. 21 Lei 12850/13 - 6 (seis) meses a 2 (dois) anos e multa',
    r'((D|d)esobedi(ê|e)ncia)|((D|D)ESOBEDI(Ê|E)NCIA)':'DESOBEDIÊNCIA - detenção, de 15 dias a 6 meses, e multa',
    r'((C|c)rime|CRIME)( |)((D|d)(E|e))':'CRIME - '}
...
def getPena(dictFull,key=1,types='DESCR'):
    ...
    try:
        arrayStr=dictFull[key].split('\n')
        for i, Str in enumerate(arrayStr):
            for _ in re.finditer(typesSear[types],Str):
                control.append(i)
        if len(control)>0:
            for _ in control:
...
def encodImageWand(wand:Image):
    img_buffer = numpy.asarray(bytearray(wand.make_blob(format='JPEG')), dtype='uint8')
    bytesio = io.BytesIO(img_buffer).getvalue()
    return bytesio
...
def motorOrgan(_hash):
    ...
    try:
        for key, value in mensageDict.items():
            ...
            else: result={'{_hash}':'Ops, ainda estamos em desenvolvimento'}
        return 'OK', json.dumps(result,ensure_ascii=False)
    except Exception as e: return 'NOK', str(e)

def normalizationType(path,bytes,msgPoint=1):
    ext=path.split('.')
    ext=ext[len(ext)-1]
    _hash=hashlib.md5(str(time.time()).encode('utf-8')).hexdigest()
    try:
        if ext in ['pdf','Pdf','PDF']:
            with(Image(blob=bytes,resolution=200)) as source: 
                images = source.sequence
                if len(images)>1:
                    for page in images:
                        if not getMsgsAndBounds(getVisionFile(encodImageWand(page)),_hash,msgPoint): break
                        msgPoint+=1
                else: getMsgsAndBounds(getVisionFile(encodImageWand(images),True),_hash,msgPoint) 
        else: getMsgsAndBounds(getVisionFile(bytes,True),_hash,msgPoint)
        return _hash
    except Exception as e: return f'Exception - {str(e)}'
...
def pipeLineISA(request): 
    print('Initiating Process pipeLineISA')
    try:
        ...
        _hash = normalizationType(nameFile,file)
        if not re.search(r'Exception', _hash):
            status, msg = motorOrgan(_hash)
            return response_json(msg, status)
        else: return response_json('CAMADA 2 | '+str(_hash), 'NOK')
    except Exception as e: return response_json('CAMADA 1 | '+str(e),'NOK')